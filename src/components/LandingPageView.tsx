...
export const LandingPageView: React.FC<LandingPageViewProps> = ({
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col antialiased selection:bg-[#D4AF37] selection:text-slate-950 font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-2.5">
              <span className="font-extrabold text-base sm:text-lg tracking-wider text-slate-900 font-['Cinzel',serif]">
              ...
              <span className="hidden sm:inline-block text-xs font-semibold text-slate-600">
                SEKORNA <span className="text-slate-400 font-normal">· Asesmen Terpadu Narkotika</span>
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3">
            <button
              onClick={() => onGoToLogin()}
              className="bg-slate-900 hover:bg-slate-800 text-white font-semibold text-xs px-4 py-2 rounded-lg shadow-xs flex items-center space-x-2 transition-all cursor-pointer border border-slate-800"
            >
      ...
      {/* HERO SECTION - Clean, Centered, Authoritative */}
      <section className="relative overflow-hidden py-16 lg:py-24 bg-white border-b border-slate-200">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-7">
          {/* Acronym Badge */}
          <div className="inline-flex items-center space-x-2 bg-slate-100 text-slate-800 px-3.5 py-1.5 rounded-full text-xs font-bold tracking-wide border border-slate-200">
            ...
            <span className="text-slate-700">SElamatkan KORban NArkotika Melalui Asesmen Terpadu</span>
          </div>

          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-900 tracking-tight leading-[1.2] font-['Cinzel',serif] max-w-4xl mx-auto">
            Selamatkan Korban, <span className="text-[#B89326]">Pulihkan Masa Depan</span>, Sikat Habis Sindikat.
          </h1>

          <p className="text-slate-600 text-sm sm:text-base leading-relaxed max-w-3xl mx-auto font-normal">
            Melalui gerakan <strong>SEKORNA</strong>, negara hadir membedakan secara tegas antara korban penyalahguna yang wajib disembuhkan melalui rehabilitasi medis & sosial, dengan bandar dan pengedar gelap yang wajib ditindak seberat-beratnya demi kepastian hukum.
          </p>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-center gap-3 pt-2">
            <button
              onClick={() => onGoToLogin()}
              className="bg-slate-900 hover:bg-slate-800 text-white font-bold text-sm px-7 py-3 rounded-xl shadow-sm flex items-center justify-center space-x-2.5 transition-all cursor-pointer border border-slate-800 hover:scale-[1.01]"
            >
            ...
            <a
              href="#lacak-berkas"
              className="bg-white hover:bg-slate-50 text-slate-800 border border-slate-300 font-semibold text-sm px-6 py-3 rounded-xl flex items-center justify-center space-x-2 transition-all shadow-2xs"
            >
          ...
          {/* Clean Harmonious Indicators */}
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5 pt-6 max-w-3xl mx-auto text-xs">
            <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-200">
              <span className="font-extrabold text-2xl text-slate-900 block font-mono">6 HARI</span>
              <span className="text-slate-500 font-medium">Batas Maksimal SLA</span>
            </div>
            <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-200">
              <span className="font-extrabold text-2xl text-slate-900 block font-mono">7 BERKAS</span>
              <span className="text-slate-500 font-medium">Uji Formil Wajib</span>
            </div>
            <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-200">
              <span className="font-extrabold text-2xl text-slate-900 block font-mono">100%</span>
              <span className="text-slate-500 font-medium">Keabsahan QR Siber</span>
            </div>
            <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-200">
              <span className="font-extrabold text-2xl text-slate-900 block font-mono">1x24 JAM</span>
              <span className="text-slate-500 font-medium">Pendaftaran Tangkap</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="gerakan-sekorna" className="py-14 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          <div className="text-center max-w-3xl mx-auto space-y-3">
            <div className="inline-flex items-center space-x-2 text-xs font-bold uppercase tracking-wider text-slate-800 bg-slate-100 px-3.5 py-1.5 rounded-lg border border-slate-200">
              <LifeBuoy className="w-4 h-4 text-[#B89326]" />
              <span>DOKTRIN & FILOSOFI PENYELAMATAN GENERASI BANGSA</span>
            </div>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight font-['Cinzel',serif]">
              Inisiatif <span className="text-[#B89326]">SEKORNA</span>: SElamatkan KORban NArkotika
            </h2>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed max-w-2xl mx-auto">
              Singkatan kata <strong>SEKORNA</strong> merangkum tekad dan komitmen moral Tim Asesmen Terpadu Polri & BNN: <em>memulihkan korban yang terjerumus kecanduan dengan rehabilitasi, seraya menumpas pengedar dan bandar tanpa kompromi</em>.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 space-y-4 hover:border-slate-300 transition-all">
              <div className="flex items-center justify-between">
                <span className="font-mono text-3xl font-black text-slate-900 bg-white border border-slate-200 w-14 h-14 rounded-2xl flex items-center justify-center shadow-2xs">
                  SE
                </span>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 space-y-4 hover:border-slate-300 transition-all">
              ...
              <div>
                ...
                <p className="text-xs text-slate-600 mt-2 leading-relaxed">
                  Melalui instrumen WHO ASSIST dan uji laboratorium toksikologi, Tim Asesmen memverifikasi status tersangka secara objektif. Korban murni diarahkan ke rehabilitasi medis dan sosial, menghindarkan mereka dari stigmatisasi dan penularan kriminalitas di dalam lapas.
                </p>
              </div>
              <div className="pt-3 border-t border-slate-200 text-[11px] font-semibold text-slate-700 flex items-center space-x-1.5">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 space-y-4 hover:border-slate-300 transition-all">
              ...
              <div>
                ...
                <p className="text-xs text-slate-600 mt-2 leading-relaxed">
                  Penyelamatan korban berjalan beriringan dengan penegakan hukum yang tanpa ampun terhadap produsen, penyelundup, dan pengedar gelap narkotika. Batas ketat berat barang bukti (SEMA 04/2010) memastikan tidak ada celah bagi sindikat untuk menyamar sebagai korban.
                </p>
              </div>
              <div className="pt-3 border-t border-slate-200 text-[11px] font-semibold text-slate-700 flex items-center space-x-1.5">
                <ShieldCheck className="w-3.5 h-3.5 text-slate-500" />
                <span>SEMA 04/2010 & Pasal 112/114 UU 35/2009</span>
              </div>
            </div>
          </div>

          {/* Moral Manifesto Banner */}
          <div className="bg-slate-900 text-white rounded-2xl p-6 sm:p-7 flex flex-col md:flex-row items-center justify-between gap-6 border border-slate-800">
            ...
            <button
              onClick={() => onGoToLogin()}
              className="bg-[#D4AF37] hover:bg-[#c49f2c] text-slate-950 font-bold text-xs px-5 py-3 rounded-xl shrink-0 transition-all cursor-pointer flex items-center space-x-2 shadow-xs"
            >
      ...
      <section id="lacak-berkas" className="py-14 bg-slate-50 border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="text-center space-y-2 mb-7">
            <div className="inline-flex items-center space-x-2 text-[11px] font-bold uppercase tracking-wider text-slate-700 bg-white px-3 py-1 rounded-md border border-slate-200">
          ...
          <form onSubmit={handleTrack} className="bg-white border border-slate-200 rounded-2xl p-4 sm:p-5 space-y-3.5 shadow-xs">
            <div className="flex flex-col sm:flex-row gap-2.5">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  placeholder="Ketik Nomor Permohonan Doket (misal: TAT-089 atau nama terperiksa)..."
              ...
              <button
                type="submit"
                className="bg-slate-900 hover:bg-slate-800 text-white text-xs sm:text-sm font-bold px-6 py-2.5 rounded-xl flex items-center justify-center space-x-2 cursor-pointer transition-all shrink-0"
              >
            ...
            <div className="flex flex-wrap items-center gap-2 text-xs pt-1">
              <span className="text-slate-500">Contoh Registrasi Doket:</span>
          ...
          {trackedResult && trackedResult !== 'not_found' && (
            <div className="mt-6 p-6 bg-white border border-slate-200 rounded-2xl space-y-5 animate-in fade-in duration-200 shadow-sm">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-slate-100">
                <div>
                  <div className="flex items-center space-x-2.5">
                    <span className="font-mono font-bold text-base text-slate-900">{trackedResult.nomorPermohonan}</span>
                    <span className="text-[10px] bg-slate-100 text-slate-700 font-bold px-2.5 py-0.5 rounded border border-slate-200 uppercase tracking-wider">
              ...
              <div className="flex justify-end pt-2">
                <button
                  onClick={() => onGoToLogin()}
                  className="bg-slate-900 hover:bg-slate-800 text-white text-xs font-bold px-4 py-2 rounded-xl flex items-center space-x-2 transition-all cursor-pointer"
                >
                  <span>Masuk Portal Petugas untuk Melihat Berkas Lengkap</span>
          ...
          {trackedResult === 'not_found' && (
            <div className="mt-5 p-4 bg-amber-50 border border-amber-200 rounded-2xl text-xs text-amber-800 flex items-center space-x-3">
      ...
      <section id="alur-layanan" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          <div className="text-center max-w-3xl mx-auto space-y-2">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 tracking-tight font-['Cinzel',serif]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div
                key={item.step}
                className="bg-slate-50 p-5 rounded-2xl border border-slate-200 space-y-3 hover:bg-white hover:shadow-sm transition-all group"
              >
                <div className="flex items-center justify-between">
                  <div className="w-9 h-9 rounded-xl bg-white border border-slate-200 flex items-center justify-center">
                    {item.icon}
                  </div>
                  <span className="font-mono font-extrabold text-sm text-slate-400 group-hover:text-slate-900 transition-colors">{item.step}</span>
                </div>
                <div>
      ...
      <section id="pengawasan" className="py-16 bg-slate-50 border-t border-slate-200">
          ...
          <div className="bg-white rounded-3xl p-8 lg:p-12 border border-slate-200 shadow-sm">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-8 space-y-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2 text-xs font-semibold">
                  <div className="bg-slate-50 p-3 rounded-xl border border-slate-200 text-center">
                    <span className="text-slate-900 font-bold block">Wajib Lapor</span>
                    <span className="text-[11px] text-slate-500 font-normal">Mingguan / Berkala</span>
                  </div>
                  <div className="bg-slate-50 p-3 rounded-xl border border-slate-200 text-center">
                    <span className="text-slate-900 font-bold block">Uji Toksikologi</span>
                    <span className="text-[11px] text-slate-500 font-normal">Acak Bebas Relapse</span>
                  </div>
                  <div className="bg-slate-50 p-3 rounded-xl border border-slate-200 text-center">
                    <span className="text-amber-800 font-bold block">Sanksi SP-1 s/d SP-3</span>
                    <span className="text-[11px] text-slate-500 font-normal">Pencabutan Hak RJ</span>
                  </div>
                  <div className="bg-slate-50 p-3 rounded-xl border border-slate-200 text-center">
                    <span className="text-emerald-800 font-bold block">Sertifikat SKSP</span>
                    <span className="text-[11px] text-slate-500 font-normal">Kelulusan Resmi</span>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-4 flex flex-col justify-center space-y-3">
                <button
                  onClick={() => onGoToLogin()}
                  className="w-full bg-slate-900 hover:bg-slate-800 text-white font-bold text-sm py-3.5 px-6 rounded-xl flex items-center justify-center space-x-2 transition-all cursor-pointer shadow-xs"
                >
                  <LogIn className="w-4 h-4 text-[#D4AF37]" />
                  <span>Masuk & Buka Buku Pengawasan</span>
                </button>
              </div>
            </div>
          </div>
      ...
      <section id="dasar-hukum" className="py-14 bg-white border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          <div className="text-center max-w-2xl mx-auto space-y-2">
            <h2 className="text-xl sm:text-2xl font-bold text-slate-900 flex items-center justify-center space-x-2 font-['Cinzel',serif]">
              <BookOpen className="w-5 h-5 text-[#B89326]" />
              <span>Landasan Hukum Operasional Penanganan Perkara</span>
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-xs">
            <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 space-y-1.5">
              <span className="font-bold text-slate-900 block text-sm">UU No. 35 Tahun 2009</span>
              <p className="text-slate-600 text-[11px]">Pasal 54 & 103: Mandat rehabilitasi medis & sosial bagi pecandu dan korban penyalahgunaan narkotika.</p>
            </div>
            <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 space-y-1.5">
              <span className="font-bold text-slate-900 block text-sm">SEMA No. 04 Tahun 2010</span>
              <p className="text-slate-600 text-[11px]">Pedoman batasan berat barang bukti untuk pemakaian 1 hari (sabu maksimal 1 gram).</p>
            </div>
            <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 space-y-1.5">
              <span className="font-bold text-slate-900 block text-sm">Perpol No. 08 Tahun 2021</span>
              <p className="text-slate-600 text-[11px]">Penerapan Keadilan Restoratif (Restorative Justice) dalam penanganan tindak pidana di lingkungan Polri.</p>
            </div>
            <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 space-y-1.5">
              <span className="font-bold text-slate-900 block text-sm">Perja No. 15 Tahun 2020</span>
              <p className="text-slate-600 text-[11px]">Penghentian penuntutan perkara pidana berdasarkan keadilan restoratif pada Kejaksaan RI.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-slate-900 text-slate-400 text-xs py-10 border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex items-center space-x-3.5">
            ...
            <div>
              <span className="font-bold text-white block text-sm font-['Cinzel',serif]">
